...
| Pantalla | Vista |
|----------|-------|
| Menú principal | ![Menú](proyecto_flask/screenshots/paneladmin_web.png) |
| Formulario de registro | ![Registro](proyecto_flask/screenshots/registro_usuario_web.png) |
| Tabla de usuarios | ![Usuarios](proyecto_flask/screenshots/usuarios_web.png) |
| Importar JSON | ![Importar](proyecto_flask/screenshots/importar_json_web.png) |
